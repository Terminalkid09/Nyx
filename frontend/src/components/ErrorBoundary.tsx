...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-950 text-gray-200 p-8">
          <div className="bg-red-900/30 border border-red-800 rounded-lg p-6 max-w-lg w-full">
            ...
            <pre className="text-xs text-red-300 bg-red-950/50 rounded p-3 overflow-auto max-h-40 mb-4 font-mono">
